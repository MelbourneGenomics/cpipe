...
def setup_parser(parser: argparse.ArgumentParser):
    ...
    parser.add_argument('-m', '--mgha', required=False, default=False, action='store_true',
    ...
    create_batch_parser.add_argument('-d', '--data', required=True, help='The fastq files to add to the batch',
                                     nargs='+', type=path_with_ext(['.fastq', '.gz']))
    create_batch_parser.add_argument('-e', '--exome', required=True,
    ...
    edit_parser.add_argument('batch', type=existing_batch, help='The name of the batch whose metadata file you '
                                                                'want to edit')
    edit_parser.add_argument('-e', '--editor', type=editor, required=False,
    ...
    add_sample_parser.add_argument('-d', '--data', nargs='+',
                                   help='The list of fastqs you want to add as samples to the batch',
                                   type=path_with_ext(['.fastq', '.gz']))
