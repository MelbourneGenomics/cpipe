...
annotate = {
    exec """
        echo "Annotating genes ..."
         ...
         JAVA_OPTS="-Xmx1g" $GROOVY -cp $TOOLS/groovy-ngs-utils/1.0.3/groovy-ngs-utils.jar $BASE/pipeline/scripts/annotate_genes.groovy -r $ANNOVAR/../humandb/hg19_refGene.txt $input.bed > $output.bed
    """
}
